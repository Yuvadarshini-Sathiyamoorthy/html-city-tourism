...
<head>
    ...
    <table border="1" width="1000px" height="800px">
        <tbody>
            <tr>
                <th colspan="2" height="60px" bgcolor="yellow">My Day</th>
            </tr>
            <tr width="50%">
                <td>1.wake up early
                <ul>
                    <li style="list-style-type: square">5 AM</li>
                    <br>
                    <li>walk</li>
                    <li>jog</li>
                </ul>
                ...
                <td rowspan="3">
                    <table border="1" width="100%" height="600px">
                        <tbody>
                            <tr>
                                <th colspan="2" height="35px" bgcolor="yellow">Things to watch
                                    
                                </th>
                            </tr>
                            <tr>
                                <td width="50%">
                                    <img src="http://www.filmofilia.com/wp-content/uploads/2012/02/The_Avengers.jpg" width="100%" height="300px">
                                </td>
                                <td width="50%">
                                    <img src="https://images.designtrends.com/wp-content/uploads/2016/04/07112320/Movie-Avengers-Wallpapers.jpg" width="100%" height="300px">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <img src="https://hdqwalls.com/download/avengers-infinity-war-official-poster-2018-4o-2048x2048.jpg" width="100%" height="300px">
                                </td>
                                <td>
                                    <img src="https://coronadotimes.com/wp-content/uploads/2019/04/avengers-endgame-poster-square-crop.jpg" width="100%" height="300px">
                                </td>
                            </tr>
            ...
            <tr>
                <td width="50%">2.breakfast
                <ul>
                    <li style="list-style-type: square">8 AM</li>
                    <br>
                    <li>egggs</li>
                    <li>coffee</li>
                </ul>
...
```
#### Output
![image](https://github.com/Yuvadarshini-Sathiyamoorthy/html-city-tourism/assets/93482485/992dabe7-b7d5-4870-b462-ee1296c622fd)
#### Result:
